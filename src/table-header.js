...
export default {
  ...
  methods: {
    ...
    getHeaderCellStyle(rowIndex, columnIndex, row, column) {
      ...
      let headerCellStyles = headerCellStyle ?? {}
      if (typeof headerCellStyle === 'function') {
        headerCellStyles = headerCellStyle.call(null, {
          rowIndex,
          columnIndex,
          row,
          column
      ...
      const fixedStyle = getFixedColumnOffset(columnIndex, column.fixed, this.store, row, this.hasGutter)
    ...
    getHeaderCellClass(rowIndex, columnIndex, row, column) {
      ...
      if (rowIndex === 0 && this.isCellHidden(columnIndex, row)) {
        ...
        classes.push(...getFixedColumnsClass(
          columnIndex,
          column.fixed,
          this.store,
          row
